...
public enum wProfessionSkills {
    ...
    INTOUCH(wAbilities.Intelligence, MAGICALTRAINING),
    ...
    NATUREATTUNEMENT(wAbilities.Empathy, INITIATEOFTHEGODS),
    READNATURE(wAbilities.Intelligence, NATUREATTUNEMENT),
    ...
    MEDITATION(wAbilities.Intelligence, WITCHERTRAINING),
    MAGICALSOURCE(wAbilities.Intelligence, MEDITATION),
    HELIOTROPE(wAbilities.Will, MAGICALSOURCE),
    IRONSTOMACH(wAbilities.Intelligence, WITCHERTRAINING),
    FRENZY(wAbilities.Intelligence, IRONSTOMACH),
