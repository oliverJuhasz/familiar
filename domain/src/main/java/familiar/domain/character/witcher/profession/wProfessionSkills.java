...
public enum wProfessionSkills {
    ...
    INTOUCH(wAbilities.NULL, MAGICALTRAINING),
    ...
    NATUREATTUNEMENT(wAbilities.NULL, INITIATEOFTHEGODS),
    READNATURE(wAbilities.NULL, NATUREATTUNEMENT),
    ...
    MEDITATION(wAbilities.NULL, WITCHERTRAINING),
    MAGICALSOURCE(wAbilities.NULL, MEDITATION),
    HELIOTROPE(wAbilities.WILL, MAGICALSOURCE),
    IRONSTOMACH(wAbilities.NULL, WITCHERTRAINING),
    FRENZY(wAbilities.NULL, IRONSTOMACH),
