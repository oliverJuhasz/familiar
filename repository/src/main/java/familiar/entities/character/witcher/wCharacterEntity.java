...
public class wCharacterEntity extends RPGCharacterEntity {
    ...
    @MapKeyColumn(name = "`Ability`", length = 40, nullable = false)
    ...
    @MapKeyColumn(name = "`Skill`", length = 40, nullable = false)
    @MapKeyEnumerated(EnumType.STRING)
    ...
    @MapKeyColumn(name = "`Profession`", length = 40, nullable = false)
    @MapKeyEnumerated(EnumType.STRING)
    @Column(name = "`CoreSkillValue`")
